 ...
 * for both tocoind and tocoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Satoshi");


#include <tocoin-build-info.h>
// The <tocoin-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/tocoin/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure tocoin Core copyright is not removed by accident
    if (copyright_devs.find("tocoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The tocoin Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/tocoin/tocoin>";
