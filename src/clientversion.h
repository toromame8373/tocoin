...
#ifndef tocoin_CLIENTVERSION_H
#define tocoin_CLIENTVERSION_H
...
#error Client version information missing: version is not defined by tocoin-build-config.h or in any other way
#endif
